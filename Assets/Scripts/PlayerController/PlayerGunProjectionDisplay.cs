...
public class PlayerGunProjectionDisplay : MonoBehaviour
{
  ...
  {
    projectionLocation.transform.localScale = platformPrefab.transform.localScale;
    projectionLocation.GetComponent<MeshRenderer>().material = platformPrefab.GetComponent<MeshRenderer>().sharedMaterial;
  }
